...
<svg width="1200" height="630" viewBox="0 0 1200 630" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="600" y="400" text-anchor="middle" fill="#d4af37" font-family="Centaur" font-size="24">
    One intelligence across desktop, web, mobile, and voice
  </text>
  <text x="600" y="438" text-anchor="middle" fill="#d4af37" font-family="Centaur" font-size="22">
  ...
  <text x="600" y="513" text-anchor="middle" fill="#d4af37" font-family="Centaur" font-size="24" font-weight="400" letter-spacing="1.1">
