...
- [ ] **`SkiaFullAdapter`** upstream defaults and “calls SKIA, does not replace it” are documented (**`1.0.0`** baseline)
- [ ] Dependencies on SKIA runtime contracts are documented
