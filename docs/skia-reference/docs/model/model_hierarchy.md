# skia model hierarchy

## Purpose
This document belongs to the docs\model\skia_model_hierarchy.md domain and is maintained as part of the current SKIA documentation set.
