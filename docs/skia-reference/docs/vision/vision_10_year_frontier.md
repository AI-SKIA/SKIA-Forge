# skia 10 year frontier

## Purpose
This document belongs to the docs\vision\skia_10_year_frontier.md domain and is maintained as part of the current SKIA documentation set.
