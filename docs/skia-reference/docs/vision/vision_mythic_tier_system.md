# skia mythic tier system

## Purpose
This document belongs to the docs\vision\skia_mythic_tier_system.md domain and is maintained as part of the current SKIA documentation set.
