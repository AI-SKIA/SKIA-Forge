# skia mythic tier spec

## Purpose
This document belongs to the docs\vision\skia_mythic_tier_spec.md domain and is maintained as part of the current SKIA documentation set.
