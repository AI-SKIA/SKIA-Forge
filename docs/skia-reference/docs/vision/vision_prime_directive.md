# skia prime directive

## Purpose
This document belongs to the docs\vision\skia_prime_directive.md domain and is maintained as part of the current SKIA documentation set.
