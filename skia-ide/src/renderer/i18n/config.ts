/** Keep in sync with skia.ca `frontend/lib/i18n/config.ts` (same storage keys). */
...
/** Chat API language hint (mirrors skia.ca language-mirroring). */
export function localeToApiLanguage(locale: Locale): 'en' | 'fr' | 'es' {
